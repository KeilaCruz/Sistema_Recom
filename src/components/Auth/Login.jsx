          ...
          <section className='flex flex-col'>
            ...
            <section className='flex flex-col'>
              <form action="" className='flex flex-col gap-3 font-sans '>
                <label htmlFor="" className='text-[25px] font-semibold'>Usuario</label>
                <input type="text" placeholder='Ingresa tu usuario' className='border-[1px] border-[#3B315F] p-[10px] rounded-[5px] w-[450px] text-[22px] visited:border-black '/>
              ...
              <Link to="/reestablecer-contraseña" className=' text-[20px] text-[#3B315F] underline font-semibold mt-[20px] hover:text-[#4D407E]'>¿Olvidaste tu contraseña?</Link> 
