...
export function VisualizarOrden() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    const materialValidado = validarEspecificacionesYMaterial(
      data.material_requerido
    );
    const especificacionesvalidadas = validarEspecificacionesYMaterial(
  ...
  const handleEstadoChange = async () => {
    ...
    setOrden((prevOrden) => ({
      ...prevOrden,
      estadot: !prevOrden.estadot,
    }));
  };
  return (
    <main className="h-auto  flex flex-row bg-colorFondo">
      ...
      <section className="flex flex-col w-full h-auto ml-[289px]">
        ...
        <section className="maincontainer mx-[40px] my-[20px] px-5 py-4 shadow-md bg-white rounded-[5px]">
          ...
          <section className="mt-4 w-5/6 flex bg-colorSecundario rounded text-white">
            <div className="flex-col w-[1/2] ml-10 mb-5">
              <p className="mt-2 font-semibold">Nombre del cliente</p>
              <p>
                {watch("nom_cliente")} {watch("ape_paterno_c")}{" "}
                {watch("ape_materno_c")}{" "}
              </p>
          ...
          <form className="flex font-sans mb-2">
            <div className="flex-col w-1/4 ml-5">
              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="fecha_solicitud">
                  Fecha solicitud
                </label>
                <br />
                <input
              ...
              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="tipo_trabajo">
                  Tipo de trabajo
                </label>
                <br />
                <select
              ...
              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="precio_material">
                  Precio del material
                </label>
                <br />
                <input
                  ...
                  type="number"
                  step="any"
                  {...register("precio_material")}
                  disabled={!activateEdit}
                />
              </div>

              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="precio_trabajo">
                  Precio del trabajo
                </label>
                <br />
                <input
                  ...
                  type="number"
                  step="any"
                  {...register("precio_trabajo")}
                  disabled={!activateEdit}
                />
              </div>

              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="trabajador_asignado">
            ...
            <div className="flex-col w-1/4 ml-80">
              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="fecha_entrega">
                  Fecha entrega{" "}
                </label>
                <br />
                <input
              ...
              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="material_requerido">
                  Material requerido{" "}
                </label>
                <br />
                <textarea
                  ...
                  type="text"
                  {...register("material_requerido")}
                  disabled={!activateEdit}
                ></textarea>
              </div>

              <div className="mt-5">
                <label className="etiqueta mt-5" htmlFor="expecificaciones">
