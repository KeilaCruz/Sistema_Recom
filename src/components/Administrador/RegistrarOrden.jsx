...
export function RegistrarOrden() {
  ...
  return (
    <>
      <main className="bg-colorFondo flex flex-row h-screen ">
        <aside className="fixed h-full">
          <Sidebar />
        </aside>

        <section className="flex flex-col gap-[20px] ml-2 w-full">
          <nav className="ml-[280px] p-[10px] flex flex-row items-center justify-between bg-white h-[80px]">
            <article className="flex flex-row justify-around gap-[20px] items-center">
              <button>
                <img
              ...
              <img
                src="/src/assets/icons/active/trabajosActive-icon.svg"
                alt="icono de trabajador"
                className="h-[30px]"
              />
              <p className="text-colorMain font-sans font-bold text-[22px]">
                Nuevo trabajo
              </p>
            </article>

            <article className="profile-dropwdown flex flex-ro items-center gap-[10px]">
              <img
          ...
          <section className="p-[10px] shadow m-[10px] bg-white ml-[290px] rounded-[5px]">
                 ...
                 <label>
                  ...
                  <label>
                    ...
                    <input
                      ...
                      className="p-[5px] border-red-600 border-[1px] rounded-[5px]"
                    />
